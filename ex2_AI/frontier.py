...
# [list of states, total num of states, curr. num. of states]
...
def insert(h, s):
    ...
    while i > 0 and val(f[i]) < val(
            f[(i - 1) // 2]):  # while item i's value is smaller than the value of his father, swap!
